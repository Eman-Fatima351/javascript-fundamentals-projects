...
Navigate to any app folder (e.g., Counter-App/)
...
Paste the entire contents of concepts.js and press Enter
📸 Screenshots
Add screenshots of each app here after running them locally.

App	Screenshot
Counter App	(screenshot placeholder)
To-Do App	(screenshot placeholder)
Quiz App	(screenshot placeholder)
